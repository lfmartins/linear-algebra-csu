...
% Solution: D=$\begin{bmatrix*}[r]2&1&0\\0&2&0\\0&0&1\\\end{bmatrix*}$ P=$\begin{bmatrix*}[r]5&-3&-3\\-3&4&3\\-1&3&2\\\end{bmatrix*}$
...
% Solution: $\left [ \left[\begin{matrix}0\\1\\0\\-2\end{matrix}\right], \quad \left[\begin{matrix}2\\\frac{8}{5}\\-1\\\frac{4}{5}\end{matrix}\right], \quad \left[\begin{matrix}- \frac{4}{41}\\\frac{46}{41}\\\frac{84}{41}\\\frac{23}{41}\end{matrix}\right]\right ]$
