...
% Solution: D=$\begin{bmatrix*}[r]2&1&0\\0&2&0\\0&0&1\\\end{bmatrix*}$ P=$\begin{bmatrix*}[r]3&3&-1\\3&4&-1\\1&1&0\\\end{bmatrix*}$
...
% Solution: $\left [ \left[\begin{matrix}1\\0\\0\\-2\end{matrix}\right], \quad \left[\begin{matrix}- \frac{6}{5}\\1\\1\\- \frac{3}{5}\end{matrix}\right], \quad \left[\begin{matrix}\frac{30}{19}\\\frac{13}{19}\\\frac{32}{19}\\\frac{15}{19}\end{matrix}\right]\right ]$
